...
function buffer_add_vertex(mBuff, vx, vy, vz, nx, ny, nz, u, v, col, alpha) {
	buffer_write(mBuff, buffer_f32, vx);
	buffer_write(mBuff, buffer_f32, vy);
	buffer_write(mBuff, buffer_f32, vz);
	//Vertex normal
	buffer_write(mBuff, buffer_f32, nx);
	buffer_write(mBuff, buffer_f32, ny);
	buffer_write(mBuff, buffer_f32, nz);
	//Vertex UVs
	buffer_write(mBuff, buffer_f32, u);
	buffer_write(mBuff, buffer_f32, v);
	...
	buffer_write(mBuff, buffer_u8, alpha * 255);
}
